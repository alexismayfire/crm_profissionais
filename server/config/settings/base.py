...
)  # (flowit_crm/config/settings/base.py - 3 = flowit_crm/)
APPS_DIR = ROOT_DIR.path("flowit_crm")
...
MIGRATION_MODULES = {"sites": "flowit_crm.contrib.sites.migrations"}
...
ADMINS = [
    (
        """Carlos Vieira, Rodrigo Moroni""",
        "calexandrelvieira@gmail.com, rodrigomoroni@hotmail.com",
    )
]
...
ACCOUNT_ADAPTER = "flowit_crm.users.adapters.AccountAdapter"
SOCIALACCOUNT_ADAPTER = "flowit_crm.users.adapters.SocialAccountAdapter"
...
#    'LOGIN_SERIALIZER': 'flowit_crm.users.serializers.LoginSerializer',
#}
